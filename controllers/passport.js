...
//goi khi xac thuc thanh cong va luu thong tin user vao session
passport.serializeUser((user, done) => {
    done(null, user.id);
})

//ham duoc goi boi passport.session de lay thong tin cua user tu CSDL va dua vao ewq.user
...
//Ham xac thu nguoi dung khi dang nhap
