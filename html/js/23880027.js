    ...
    if (confirm('Do you really want to remove this product??')) {
        ...
        if (res.status == 200) {
            ...
            if (json.quantity > 0) {
                ...
                document.querySelector('.cart-page .container').innerHTML = `<div class="text-center border py-3"><h3>Your cart is empty!</h3></div>`
            }
...
async function clearCart() {
    if (confirm('Do you really want to remove all your products??')) {
